...
import "./BlackSwanToken.sol";

contract BlackSwanTokenPreSale {
    BlackSwanToken public token;
    ...
    function BlackSwanTokenPreSale(
        BlackSwanToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = BlackSwanToken(_token);
